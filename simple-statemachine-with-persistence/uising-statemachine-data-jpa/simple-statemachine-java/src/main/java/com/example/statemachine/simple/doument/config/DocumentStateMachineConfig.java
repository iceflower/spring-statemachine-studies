...
public class DocumentStateMachineConfig
  ...
  private final StateMachineRuntimePersister<DocumentState, DocumentEvent, String> stateMachineRuntimePersister;

  public DocumentStateMachineConfig(
    final StateMachineRuntimePersister<DocumentState, DocumentEvent, String> stateMachineRuntimePersister) {
