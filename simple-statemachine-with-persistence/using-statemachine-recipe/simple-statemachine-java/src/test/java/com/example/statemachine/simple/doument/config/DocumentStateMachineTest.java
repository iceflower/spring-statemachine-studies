...
public class DocumentStateMachineTest {
  ...
  class DescribeOf_DocumentStateMachine {
    ...
    @Nested
    @DisplayName("DB에 존재하지 않는 documentID가 주어지면")
    class ContextWhen_given_not_persisted_documentId {
      ...
      void its_state_not_changed(DocumentEvent event) throws Exception {
        ...
        stateMachineUnitTestHelper.sendEvent(5, event);
    ...
    @Nested
    @DisplayName("DB에 존재하는 documentID가 주어지고")
    class ContextWhen_given_persisted_documentId {
      @Nested
      @DisplayName("주어진 documentID의 기존 상태가 'DRAFT' 일 때")
      class ContextWhen_state_is_DRAFT {
        ...
        class ContextWith_given_DOCUMENT_PUBLISHED_BY_USER_event {
          ...
          void its_state_changed() throws Exception {
            ...
            final var prevTestPlan = stateMachineUnitTestHelper.getStateMachineTestPlan(prevState);
            prevTestPlan.test();
      ...
      @Nested
      @DisplayName("주어진 documentID의 기존 상태가 'UNDER_MEDIATION' 일 때")
      ...
      @Nested
      @DisplayName("주어진 documentID의 기존 상태가 'WAITING_FOR_PUBLIC_DISCLOSURE' 일 때")
      ...
      @Nested
      @DisplayName("주어진 documentID의 기존 상태가 'PUBLIC_DISCLOSURE' 일 때")
